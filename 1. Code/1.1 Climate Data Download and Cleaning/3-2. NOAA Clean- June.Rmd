...
for (year in 1981:2024) {
  data <- readRDS(paste0(data.processed.dir, "/2.Climate/Binsdata_midyear_", year, ".rds"))
...
dt_noaa <- dt_noaa %>% group_by(
    county_code, COUNTYFP, STATEFP, YEAR
  ) %>% summarise(
    dd5binBelowNeg7 = sum(dd5binBelowNeg7),
    dd5binBelowNeg2 = sum(dd5binBelowNeg2),
    dd5binBelow3 = sum(dd5binBelow3),
    dd5binNeg2 = sum(dd5binNeg2),
    dd5bin3 = sum(dd5bin3),
    dd5bin8 = sum(dd5bin8),
    dd5bin13 = sum(dd5bin13),
    dd5bin18 = sum(dd5bin18),
    dd5bin23 = sum(dd5bin23),
    dd5bin28 = sum(dd5bin28),
    dd5bin33up = sum(dd5bin33up),
    pbin10 = sum(pbin10),
    pbin20 = sum(pbin20),
    pbin30 = sum(pbin30),
    pbin40 = sum(pbin40),
    Pday50up = sum(Pday50up),
    prcp = sum(prcp))
```
...
saveRDS(dt_noaa_final, paste(data.processed.dir, "3. NOAA_MERGE_JUNE.rds", sep = "/"))
